...
export const styles = StyleSheet.create({
  ...
  videoModalBufferingText: {
    color: '#fff',
    fontSize: 14,
    textAlign: 'center',
  },
  videoModalBottomControls: {
    position: 'absolute',
    bottom: 50,
    left: 0,
    right: 0,
  ...
  videoModalMuteButtonText: {
    fontSize: 24,
    color: '#fff',
  },
  videoModalBrowserButton: {
    paddingHorizontal: 20,
    paddingVertical: 12,
    borderRadius: 25,
    backgroundColor: 'rgba(0, 0, 0, 0.6)',
  },
  videoModalBrowserButtonText: {
    color: '#fff',
    fontSize: 16,
    fontWeight: '500',
  },
